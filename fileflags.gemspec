Gem::Specification.new do |s|
  ...
  s.files = ["lib/fileflags.rb", "test/test_fileflags_entry.rb", "test/test_fileflags_suite.rb", "README_ja.org", "LICENSE"]
  ...
  s.summary = %q{A framework to process updated files.}
